...
|visibility|Boolean|Specifies the visibility of an Office 365 group. Possible values are: empty or true to specifiy a **Public** group or false to specify **Private**.|
